 ...
 * @version 0.9.1
 */
public class ActivationCodeAlertController implements Controller {
    /*---Fields---*/
    ...
    private StringProperty email_err_txt, required_txt, notif_connection_loss;
    ...
    public void setDiagReference(JFXDialog dialog) {
        this.dialog = dialog;
    }
